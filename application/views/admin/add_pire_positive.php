			...
			<div class="card">
				<div class="card-body">
					<h4 class="card-title font-weight-bold">Add Question</h4>
						<form class="cmxform" method="post" action="<?= base_url('admin/insert_pire_positive'); ?>">
							<fieldset>
								<div class="form-group">
									...
									<select class="form-control" name="question_for" id="question_for">
										<option value="pire_pos">Pire positive</option>
									</select>
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									...
									<textarea class="form-control" name="video_url" id="editor2" rows="10"></textarea>
								</div>
								...
								<div class="form-group tags_option">
									<label for="name" class="font-weight-bold">Options related to this question</label>
