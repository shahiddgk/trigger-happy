        <!-- partial:partials/_footer.html -->
                <footer class="footer d-flex flex-column flex-md-row align-items-center justify-content-between">
                    <p class="text-muted text-center text-md-left">Copyright © 2023 <a href="https://trigger.myfitnesshacks.com/" target="_blank">Trigger Happy</a>. All rights reserved</p>
